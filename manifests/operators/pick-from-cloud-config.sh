...
# The base manifests/redsocks.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/redsocks.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
